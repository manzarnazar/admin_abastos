                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-0">
                                ...
                                @if($deliveryMan->driver_license_image ?? null)
                                    <a href="{{ $deliveryMan->driver_license_image_full_url }}" target="_blank" class="mt-2 d-inline-block">{{ translate('View current file') }}</a>
                                @endif
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-0">
                                ...
                                @if($deliveryMan->curp_rfc_certificate_image ?? null)
                                    <a href="{{ $deliveryMan->curp_rfc_certificate_image_full_url }}" target="_blank" class="mt-2 d-inline-block">{{ translate('View current file') }}</a>
                                @endif
                                <small class="text-muted d-block">{{ translate('pdf, doc, jpg. File size : max 2 MB') }}</small>
                            </div>
                        </div>
