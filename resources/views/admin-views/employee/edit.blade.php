...
<div class="content container-fluid">
    ...
    <form action="{{route('admin.users.employee.update',[$employee['id']])}}" method="post" enctype="multipart/form-data" class="js-validate">
        ...
        data-original-title="{{ translate('messages.password_must_be_8_characters_with_number_and_capital') }}"><img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" alt="{{ translate('messages.password_must_be_8_characters_with_number_and_capital') }}"></span></label>
